"""
Django settings for RecomiendaYGana project.
...
SECRET_KEY = '*rzup91&#6i))ja$tpm%gz51q=qh5kgm+!fgre)%xdpg5lz@#^'
...
ROOT_URLCONF = 'RecomiendaYGana.urls'
...
WSGI_APPLICATION = 'RecomiendaYGana.wsgi.application'
